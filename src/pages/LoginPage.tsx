...
export const LoginPage = () => {
    ...
    const handleLogin = async (e?: any) => {
        ...
        const fakeUser = await createFakeUserFromEmail(credentials.email, {
            countryCode: market.country === 'Colombia' ? '+57' : (market.country === 'Chile' ? '+56' : '+52'),
        });
        
        // Map to app User interface
        const userToLogin = {
            ...fakeUser,
            tier: 'none',
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-slate-200">
                ...
                <div className="mt-6 pt-6 border-t border-slate-100">
                    <button 
                        onClick={(e) => {
                             e.preventDefault();
                             setCredentials({email: 'demo@mail.com', password: 'password123'});
                             // Must delay the submit or execute it manually
                             setTimeout(() => {
